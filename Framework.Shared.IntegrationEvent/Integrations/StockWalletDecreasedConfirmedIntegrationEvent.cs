...
namespace Framework.Shared.IntegrationEvent.Integration
{
    ...
    public class StockWalletDecreasedConfirmedIntegrationEvent : Framework.Core.Messages.Integration.IntegrationEvent
    {
        public Guid StockWalletId  {get;set;}
        public Guid TransactionStokId  {get;set;}
        public string Symbol {get;set;}
        public decimal Amount {get;set;}
        public StockWalletDecreasedConfirmedIntegrationEvent(
                                    Guid stockWalletId,
